...
namespace Capture.Hook
{
    ...
    internal class DXHookD3D11: BaseDXHook
    {
        ...
        public override void Hook()
        {
            ...
            DXGISwapChain_PresentHook = new Hook<DXGISwapChain_PresentDelegate>(_dxgiSwapChainVTblAddresses[(int)DXGI.DXGISwapChainVTbl.Present], new DXGISwapChain_PresentDelegate(PresentHook),
                this);
            ...
            try
            {
                ...
                if (this.Config.ShowOverlay)
                {
                    ...
                    if (_swapChainPointer != swapChain.NativePointer || _overlayEngine == null)
                    {
                        ...
                        benchmarking.benchChain = swapChain;
